                ...
                <GridItem xs={12} sm={12} md={12}>
                  <div className={classes.profile}>
                    ...
                    <div className={classes.name}>
                      {/* name */}
                      <h3 className={classes.title}>Instructor Dashboard</h3>
                      <br />
                      <h5>
                        {' '}
                        Welcome back, Instructor {user && user.lastName}!
                      </h5>
                      {/* user details */}
