                ...
                <div className='row flex-lg-row-reverse align-items-center justify-content-center g-5 py-5'>
                    ...
                    <div className='col-lg-6'>
                        ...
                        <p className='text-body text-muted'>
                            Welcome to <strong className='text-primary fw-bold'>Americoders</strong>, the #1 online and
                            in-person technology advocacy learning system for all members of our community.
                        </p>
