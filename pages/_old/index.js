...
import FeatureSectionLeft
  from '../components/structure/FeatureSectionLeft/FeatureSectionLeft'
import FeatureSectionRight
  from '../components/structure/FeatureSectionRight/FeatureSectionRight'
...
const Index = ({ courses }) => {
  ...
  const heroIntroContent = () => {
    return (<>
      We're a community enrichment program founded in the heart of the Biggest
      Little City
      ...
      >
        <Col xs={24} sm={12} md={6}>
          <Link href={'/#more-info'}><a>
            <button type="button"
                    className="btn btn-primary btn-lg shadow px-4 my-2">More
              Info
            </button>
          </a></Link>
        </Col>
  ...
  return (<>
    ...
    <Row align={'middle'} justify={'center'}
         className="py-5 container text-white text-center">
      {/* title area */}
      ...
      <Row align={'middle'} justify={'center'}>
        ...
        <Col xs={24} md={8} lg={8} className="m-5">
          <Image
            ...
            loading="lazy"
          />
          <p className="lead text-white text-center">Create a Projects
            Portfolio</p>
        </Col>
        ...
        <Col xs={24} md={8} className="m-5">
          <Image
            ...
            loading="lazy"
          />
          <p className="lead text-white text-center">Hardware
            Breakdown/Fixes</p>
        </Col>
      </Row>
    </Row>
